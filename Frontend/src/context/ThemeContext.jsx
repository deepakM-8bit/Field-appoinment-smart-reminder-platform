...
function TypeBadge({ type }) {
  ...
  return <span className={`${base} bg-slate-100 text-slate-700`}>Diagnosis</span>;
}
...
export default function TechnicianDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ✅ Summary Cards - Mobile square layout */}
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
          <p className="text-xs text-slate-500">Repair</p>
          <p className="mt-1 text-2xl font-semibold text-slate-900">
            {summary.repair}
          </p>
        </div>
      ...
      <div className="rounded-lg border border-gray-200 bg-white shadow-sm overflow-hidden">
        <div className="flex items-center justify-between border-b px-5 py-4">
          ...
          <p className="text-sm text-slate-500">{appointments.length} item(s)</p>
        </div>
