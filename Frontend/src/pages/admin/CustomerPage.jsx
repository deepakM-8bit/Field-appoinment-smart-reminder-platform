...
export default function CustomersPage() {
  ...
  if (loading) {
    return (
      <p className="py-20 text-center text-slate-500">Loading customers…</p>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <input
            className="rounded-md border border-gray-200 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-600 lg:col-span-4"
            placeholder="Address"
            value={address}
      ...
      <div className="space-y-3 lg:hidden">
        {filteredCustomers.length === 0 ? (
          <div className="rounded-lg border border-gray-200 bg-white p-6 text-center text-sm text-slate-500 shadow-sm">
            No customers found.
          </div>
        ) : (
