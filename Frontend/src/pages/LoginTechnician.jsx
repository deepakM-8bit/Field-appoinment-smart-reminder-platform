...
export default function LoginTechnician() {
  ...
  const canSubmit = useMemo(() => {
    return phoneno.trim() && password.trim() && !submitting;
  }, [phoneno, password, submitting]);
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      console.log("technician login error:", err);
      setError("Login failed. Please check your phone/password and try again.");
    } finally {
      setSubmitting(false);
    }
  };
